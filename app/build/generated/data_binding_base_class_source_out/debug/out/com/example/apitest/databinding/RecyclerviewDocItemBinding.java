...
public final class RecyclerviewDocItemBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static RecyclerviewDocItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RecyclerviewDocItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.recyclerview_doc_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RecyclerviewDocItemBinding bind(@NonNull View rootView) {
