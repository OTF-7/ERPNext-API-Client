...
public final class ActivityDocListBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityDocListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDocListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_doc_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDocListBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.doc_recyclerview;
      RecyclerView docRecyclerview = ViewBindings.findChildViewById(rootView, id);
      if (docRecyclerview == null) {
        break missingId;
      }

      id = R.id.doc_spinner;
      Spinner docSpinner = ViewBindings.findChildViewById(rootView, id);
      if (docSpinner == null) {
        break missingId;
      }
